    ...
    public partial class initialcreation : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        IsCheked = c.Boolean(nullable: true),
                        AdminCostId = c.Guid(nullable: false),
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.ParticipationServices", t => t.PSId, cascadeDelete: false)
                .ForeignKey("dbo.SubContractors", t => t.SubcontractorId, cascadeDelete: false)
                .Index(t => t.AdminCostId)
                .Index(t => t.PSId)
                .Index(t => t.SubcontractorId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.DirectDeposits", "PSId", "dbo.ParticipationServices");
            DropForeignKey("dbo.DirectDeposits", "AdminCostId", "dbo.AdminCosts");
            ...
            DropIndex("dbo.DirectDeposits", new[] { "PSId" });
            DropIndex("dbo.DirectDeposits", new[] { "AdminCostId" });
