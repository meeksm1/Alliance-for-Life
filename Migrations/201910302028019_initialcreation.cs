    ...
    public partial class initialcreation : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        AflBillable = c.Double(nullable: false),
                        ...
                        AOtherInput = c.String(),
                        AOtherInput2 = c.String(),
                        AOtherInput3 = c.String(),
                        ...
                        AllocatedBudget_AllocatedBudgetId = c.Guid(),
                    })
                .PrimaryKey(t => t.AdminCostId)
                .ForeignKey("dbo.SubContractors", t => t.SubcontractorId, cascadeDelete: true)
                .ForeignKey("dbo.AllocatedBudgets", t => t.AllocatedBudget_AllocatedBudgetId)
                .Index(t => t.SubcontractorId)
                .Index(t => t.AllocatedBudget_AllocatedBudgetId);
            
            CreateTable(
                "dbo.DirectDeposits",
                c => new
                    {
                        DirectDepositsId = c.Guid(nullable: false),
                        IsCheked = c.Boolean(nullable: false),
                        AdminCost_AdminCostId = c.Guid(),
                        ParticipationService_PSId = c.Guid(),
                    })
                .PrimaryKey(t => t.DirectDepositsId)
                ...
                c => new
                    {
                        ...
                        POtherInput = c.String(),
                        POtherInput2 = c.String(),
                        POtherInput3 = c.String(),
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.AdminCosts", t => t.AdminCostId)
                .ForeignKey("dbo.AllocatedBudgets", t => t.AllocatedBudgetId)
                .ForeignKey("dbo.ParticipationServices", t => t.PSId)
                ...
                c => new
                    {
                        ...
                        TotOverallServed = c.Double(nullable: false),
                        Month = c.Int(),
                        NonResidential_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.NonResidentialMIRs", t => t.NonResidential_Id)
                .ForeignKey("dbo.SubContractors", t => t.SubcontractorId, cascadeDelete: true)
                .Index(t => t.SubcontractorId)
                .Index(t => t.NonResidential_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.DirectDeposits", "ParticipationService_PSId", "dbo.ParticipationServices");
            DropForeignKey("dbo.DirectDeposits", "AdminCost_AdminCostId", "dbo.AdminCosts");
            ...
            DropIndex("dbo.DirectDeposits", new[] { "ParticipationService_PSId" });
            DropIndex("dbo.DirectDeposits", new[] { "AdminCost_AdminCostId" });
